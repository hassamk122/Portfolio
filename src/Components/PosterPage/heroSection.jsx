  ...
  return (
    <div className=" flex items-center justify-center flex-col   pt-15 pb-5 sm:pb-10 px-2 overflow-hidden">
      ...
      <div className='mt-8 text-center p-2'>
           <h3 className='font-quicksand font-normal  text-sm sm:text-xl  text-zinc-100 drop-shadow-[0px_5px_20px_rgba(255,255,255,0.4)]'>Check Out My Poster Design Collection..</h3>
           </div>
      <div className='pt-10'>
      <PosterCollection/>
      </div>
