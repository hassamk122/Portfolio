...
function Notfound() {
  return (
    <div className=' flex items-center justify-center flex-col text-4xl h-screen text-zinc-800 dark:text-zinc-400 font-Excalifont text-center py-40 overflow-hidden'>
